...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/thriftdemo-cppclient

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/thriftdemo-cppclient: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/thriftdemo-cppclient ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/CppClient.o: CppClient.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igen-cpp `pkg-config --cflags thrift`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CppClient.o CppClient.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/thriftdemo-cppclient
